-- Migration: Compatible with existing recipe_forks table
-- Works with your existing table structure

-- ================================================
-- RECIPE_FORKS TABLE - ADD MISSING COLUMNS ONLY
-- ================================================

-- Your existing table has:
-- - id, original_recipe_id, forked_recipe_id, forked_by_user_id, fork_reason, created_at
-- - We just need to ensure indexes exist and add any missing features
...
-- ================================================
-- USER_POSTS TABLE - CREATE IF NOT EXISTS
-- ================================================
...
-- Add trigger for user_posts updated_at
...
-- Drop any existing policies first (safe with IF EXISTS)
...
-- Create policies for recipe_forks (using your column name: forked_by_user_id)
...
-- ================================================
-- HELPER FUNCTIONS (Updated for your column names)
-- ================================================
...
-- Success message
SELECT 'Migration 004 completed successfully! Compatible with existing recipe_forks structure.' as status;